...
function HomeCard() {
  return (
    <>
      <div className="card bg-white rounded-[24px] h-[453px] w-[300px] md:w-[286px] xl:w-[364px]">
        ...
        <div className="flex justify-between items-center mx-2">
          ...
          <h3 className="text-lg font-bold text-[#24100d]">280,000</h3>
        </div>
        ...
        <div className="flex items-center mx-2 mt-2">
          <div className="flex items-center">
            <i className="fa-solid fa-bed mr-1 hidden xl:block"></i>
            <p className="text-lg ml-1 mr-2">4 Beds</p>
          </div>
          <p>|</p>
          <div className="flex items-center ml-2">
            <i className="fa-solid fa-bath mr-1 hidden xl:block"></i>
            <p className="text-lg ml-1 mr-2">2 Baths</p>
          </div>
          <p>|</p>
          <div className="flex items-center ml-2">
            <i className="fa-regular fa-square mr-1 hidden xl:block"></i>
